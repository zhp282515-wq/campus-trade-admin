...
项目一开始先做了前端页面和 Mock 数据，后面又接入了 Node.js + Express + MySQL，把前端页面逐步切换成真实接口。整体风格是常见后台系统：左侧菜单、顶部导航、浅灰背景、白色卡片、蓝色主按钮，比较适合课程设计、毕业设计初版和简历项目展示。
